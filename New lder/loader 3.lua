...
game:service "Players".LocalPlayer.OnTeleport:Connect(
    function(a)
...
getgenv().LoadLibrary = function(a)
    if a == "RbxGui" then
        return loadstring(HttpGet "https://pastebin.com/raw/fhmyjeQ9")()
    elseif a == "RbxUtility" then
        return loadstring(HttpGet "https://pastebin.com/raw/M1xCdPHY")()
    elseif a == "RbxStamper" then
        return loadstring(HttpGet "https://pastebin.com/raw/Kixiivev")()
    end
    error "Are you retard?"
    return nil
end
if ispre and game.PlaceId ~= 2377868063 then
    game.StarterGui:SetCore(
        "SendNotification",
        {
            Title = ree and "Has been re-loaded" or "Has been loaded",
            Text = "By (Co)",
            Icon = "http://www.roblox.com/asset/?id=4337256707",
            Duration = 6
        }
    )
...
if game.PlaceId ~= 2377868063 and info and not ree then
    info "Loaded"
end
